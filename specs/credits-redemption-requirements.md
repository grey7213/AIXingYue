...
- 新注册用户默认获得 `2500` 免费积分额度，对应约 `50` 次成功角色回复。
...
- 新注册免费额度从 `500` 调整为 `2500` 惑梦币，按 `CHAT_MESSAGE_COST=50` 约为 `50` 次成功角色回复。
- 只影响调整后的新注册账号；已有账号余额不自动补发或扣减。
- 首页、登录/注册页和公开运营配置的注册送额度文案同步为 `2500` 惑梦币、约 `50` 次回复。
